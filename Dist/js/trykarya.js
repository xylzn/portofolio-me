...
// Data contoh untuk karya
const news = [
    { id: 'logo1', title: 'Logo', imageUrl: 'Dist/Foto/Gallery/Logo/AR TECHNO.jpg', url: 'https://example.com/logo' },
    { id: 'vector1', title: 'Karya Terbaru', imageUrl: 'Dist/Foto/Gallery/Vector/Vektor Gaming.jpg', url: 'https://example.com/karya-terbaru' },
    { id: 'apparel1', title: 'Apparel', imageUrl: 'Dist/Foto/Gallery/Apparel/Tiger.jpg' },
    { id: 'packaging1', title: 'Pack', imageUrl: 'Dist/Foto/Gallery/Packaging/Design Lomba 1.jpg' },
    { id: 'poster1', title: 'Poster', imageUrl: 'Dist/Foto/Gallery/Poster/Poster Hayu Olahraga 2.jpg' },
];
const logos = [
    { id: 'logo1', title: 'Logo', imageUrl: 'Dist/Foto/Gallery/Logo/AR TECHNO.jpg', url: 'https://example.com/logo' },
...
function createLogoGallery() {
    ...
    logoTitle.className = 'text-2xl font-bold text-orange-500 mt-10 mb-5';
...
function createVectorGallery() {
    ...
    vectorTitle.className = 'text-2xl font-bold text-orange-500 mt-10 mb-5';
    vectorTitle.textContent = 'Vector';
    vectorSection.appendChild(vectorTitle);
...
function createApparelGallery() {
    ...
    apparelTitle.className = 'text-2xl font-bold text-orange-500 mt-10 mb-5';
    apparelTitle.textContent = 'Apparel';
    apparelSection.appendChild(apparelTitle);
...
function createPackagingGallery() {
    ...
    packagingTitle.className = 'text-2xl font-bold text-orange-500 mt-10 mb-5';
    packagingTitle.textContent = 'Packaging';
    packagingSection.appendChild(packagingTitle);
...
function createPosterGallery() {
    ...
    posterSection.className = 'text-2xl font-bold text-orange-500 mt-10 mb-5';
    posterTitle.textContent = 'Poster';
    posterSection.appendChild(posterTitle);
